<x-bootstrap-layout>
    ...
    @include('profil.partials.hero', [
        'title' => 'Kontak Kelurahan Jelupang',
        'subtitle' => 'Informasi kontak dan lokasi Kelurahan Jelupang'
    ])
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-9">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title mb-0"><i class="bi bi-envelope me-2"></i> Hubungi Kami</h5>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row g-3">
