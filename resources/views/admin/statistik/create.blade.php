<x-admin-bootstrap-layout>
    <x-slot name="header">
        <h1 class="h3 mb-0">Tambah Statistik</h1>
    </x-slot>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('kategori_statistik_id') is-invalid @enderror" id="kategori_statistik_id" name="kategori_statistik_id" required>
                                        ...
                                        @foreach($kategori as $kat)
                                            <option value="{{ $kat->id }}" {{ old('kategori_statistik_id') == $kat->id ? 'selected' : '' }}>{{ $kat->nama }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('nilai') is-invalid @enderror" id="nilai" name="nilai" value="{{ old('nilai') }}" required>
                                    @error('nilai')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('satuan') is-invalid @enderror" id="satuan" name="satuan" value="{{ old('satuan') }}" placeholder="contoh: orang, kg, %">
                                    @error('satuan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('tahun') is-invalid @enderror" id="tahun" name="tahun" value="{{ old('tahun', date('Y')) }}" min="2000" max="{{ date('Y') + 1 }}" required>
                                    @error('tahun')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
