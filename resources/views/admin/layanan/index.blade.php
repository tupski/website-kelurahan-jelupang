<x-admin-bootstrap-layout>
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <h2 class="fs-4">Daftar Layanan</h2>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <form action="{{ route('admin.layanan.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus layanan ini?')">
                                            @csrf
                                            @method('DELETE')
