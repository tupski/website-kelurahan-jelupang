                ...
                <div class="card-body">
                    <form action="{{ route('admin.layanan.update', $layanan->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('persyaratan') is-invalid @enderror" id="persyaratan" name="persyaratan" rows="4">{{ old('persyaratan', $layanan->persyaratan) }}</textarea>
                            @error('persyaratan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jam_layanan') is-invalid @enderror" id="jam_layanan" name="jam_layanan" value="{{ old('jam_layanan', $layanan->jam_layanan) }}" placeholder="contoh: Senin-Jumat, 08.00-16.00 WIB">
                                    @error('jam_layanan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi" value="{{ old('lokasi', $layanan->lokasi) }}">
                                    @error('lokasi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bi {{ $layanan->ikon ?: 'bi-file-earmark-text' }}"></i></span>
                                        <input type="text" class="form-control @error('ikon') is-invalid @enderror" id="ikon" name="ikon" value="{{ old('ikon', $layanan->ikon) }}" placeholder="contoh: bi-file-earmark-text">
                                    </div>
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="aktif" name="aktif" {{ old('aktif', $layanan->aktif) ? 'checked' : '' }}>
