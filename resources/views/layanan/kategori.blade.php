<x-bootstrap-layout>
    ...
    <div class="hero-section" style="background-color: {{ App\Models\Pengaturan::get('warna_utama', '#00A67C') }}; position: relative; overflow: hidden;">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h1 class="display-5 fw-bold mb-3">{{ App\Models\Pengaturan::get('judul_layanan', 'PELAYANAN DESA JELUPANG') }}</h1>
    ...
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <h5 class="mb-0">LAYANAN DESA: {{ strtoupper($kategori->nama) }}</h5>
                </div>
                <p>{{ $kategori->deskripsi ?? 'Pilih kategori untuk melihat layanan desa sesuai dengan kebutuhan Anda' }}</p>
            </div>
        </div>

        <!-- Search Form -->
        <div class="mb-4">
            <form id="searchForm" action="{{ route('layanan.kategori', $kategori->slug) }}" method="GET">
        ...
        <div class="mb-4" id="kategoriFilter">
            ...
            <a href="{{ route('layanan.kategori', $kat->slug) }}" class="btn {{ $kategori->id == $kat->id ? 'btn-primary' : 'btn-outline-primary' }} rounded-pill me-2 mb-2 kategori-btn" data-url="{{ route('layanan.kategori', $kat->slug) }}">
